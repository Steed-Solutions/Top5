  ...
  $.fn.wysiwyg = function (userOptions) {
    var editor = this,
      ...
      execCommand = function (commandWithArgs, valueArg) {
        ...
        if (
          "insertunorderedlist|insertorderedlist|justifyleft|justifycenter|justifyright|justifyfull".includes(
            commandWithArgs
          )
        ) {
      ...
      bindToolbar = function (toolbar, options) {
        ...
        toolbar
          ...
          .on("webkitspeechchange change", function () {
            var newValue = this
              .value; /* ugly but prevents fake double-calls due to selection restoration */
            this.value = "";
            restoreSelection();
            if (newValue) {
              editor.focus();
        ...
        // toolbar
        //   .find("input[type=file][data-" + options.commandRole + "]")
        //   .change(function () {
        //     restoreSelection();
