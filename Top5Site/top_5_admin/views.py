...
cred = adminCredentials.Certificate(finders.find(
    'site_admin/key/top-50-9951b-firebase-adminsdk-6n5a9-5a5dfe7f4d.json'))
...
def categoryDash(request, category_id=""):
    ...
    return render(request, "admin/categoryDash.html", {"categoryID": category_id, "categoryPosts": json.dumps(categoryPostsMap), "words": words})
